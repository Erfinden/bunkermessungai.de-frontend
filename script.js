...
function showData(key) {
    fetch('https://128.140.90.80:5000/user_read', {
        method: 'POST',
...
function updatelowervalue() {
    ...
    if (lowervalue.match(/^(100|[1-9][0-9]?)$/)) {
        ...
        if (lowervalue == sendpercentlower) {
            ...
            fetch('https://128.140.90.80:5000/update_lowervalue', {
                method: 'POST',
...
function updateuppervalue() {
    ...
    if (uppervalue.match(/^(100|[1-9][0-9]?)$/)) {
        ...
        if (uppervalue == sendpercentupper) {
            ...
            fetch('https://128.140.90.80:5000/update_uppervalue', {
                method: 'POST',
...
function updateEmail() {
    ...
    if (email.match(validRegex)) {
        fetch('https://128.140.90.80:5000/update_email', {
            method: 'POST',
...
function updateName() {
    ...
    if(name){
        fetch('https://128.140.90.80:5000/update_name', {
            method: 'POST',
...
function deleteAccount() {
    ...
    if (result){
        ...
        if (result2) {
            ...
            fetch('https://128.140.90.80:5000/remove', {
                method: 'POST',
                body: new URLSearchParams({ key })
            })
                .then(response => response.text())
